...
class SGY:
    ...
    def _init_fields_header(self):
        ...
        filename_gen_hdr = Path('file_header.csv').resolve()
        ...
        name_tr_hdr = Path('trace_header.csv').resolve()
    ...
    def _read_traces_ibm(self):
        raise ValueError('Not implemented reader')
...
if __name__ == '__main__':
    sgy = SGY()
    filename = Path.cwd().parents[0]
    filename = filename / 'examples' / 'real_gather.sgy'
